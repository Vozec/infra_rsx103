...
sudo iptables -A FORWARD -s 192.168.30.0/24 -d 192.168.20.0/24 -p udp --dport 53 -j ACCEPT
...
sudo iptables -A FORWARD -s 192.168.40.0/24 -d 192.168.20.0/24 -p udp --dport 53 -j ACCEPT
