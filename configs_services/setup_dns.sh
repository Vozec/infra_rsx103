...
sudo bash -c 'echo "address=/prometheus.monentreprise.lan/192.168.40.10" >> /etc/dnsmasq.conf'
sudo bash -c 'echo "address=/grafana.monentreprise.lan/192.168.40.10" >> /etc/dnsmasq.conf'
sudo bash -c 'echo "address=/alertmanager.monentreprise.lan/192.168.40.10" >> /etc/dnsmasq.conf'
sudo bash -c 'echo "address=/vpn-admin.monentreprise.lan/192.168.40.20" >> /etc/dnsmasq.conf'
sudo bash -c 'echo "address=/ldap-manager.monentreprise.lan/192.168.40.20" >> /etc/dnsmasq.conf'
